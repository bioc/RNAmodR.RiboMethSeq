...
```{r}
gff <- GFF3File(system.file("extdata","example_RMS.gff3",package = "RNAmodR.Data"))
fasta <- FaFile(system.file("extdata","example_RMS.fasta",package = "RNAmodR.Data"))
...
```{r}
msrms <- ModSetRiboMethSeq(files, annotation = gff, sequences = fasta)
```
